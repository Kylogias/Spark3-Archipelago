...
4. One launched, press F5 to open the preference manager, go into the "Archipelago Connection" tab, and enter the connection information
5. Delete a save if necessary and start a new game, the client will automatically connect after selecting a save file
